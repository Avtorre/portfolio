  ...
  return (
    <div className="h-7/12 2xl:h-3/5 w-3/5 2xl:w-3/6 m-auto border-zinc-700 border-2 rounded-xl border-solid p-4">
        ...
        <div className="flex">
          ...
          <div className="w-fit ml-auto self-end">
            ...
            <Link href="https://www.codewars.com/users/Avtorre" target="_blank">
              <Image className="inline ml-2 hover:shadow-lg border-1 rounded-lg border-zinc-700 p-1" src={'/codewars.svg'} alt="" width={35} height={35}/>  
            </Link>
          </div> 
        </div>
      ...
      <h3 className="font-bold mt-1 text-xl my-2">Education:</h3> 
        ...
        <div className="w-1/3 ml-11 mr-auto columns-2 pl-3 gap-0">
