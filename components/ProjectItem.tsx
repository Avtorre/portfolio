...
const ProjectItem = (props: {imageSrc: string, title: string, description: string}) => {
  ...
  return (
    <div className="w-72 mx-6 hover:shadow-xl border-2 border-zinc-800 rounded-2xl">
      <Image src={props.imageSrc} width={288} height={146} alt={props.title} className="rounded-t-[13px] "/>
      <div className="h-24 p-1 rounded-b-[13px] bg-zinc-400/[.3] border-t-2 border-zinc-800 ">
